...
model_path = '/home/akk/MTR-deploy/ckpt-best/model'
...
bbox_attrs, bbox_conf, bbox_cls_conf, bbox_cls, nms_idx, nms_count = \
    rotated_nms3d(bbox_attrs, bbox_conf, bbox_cls_conf, bbox_cls, nms_overlap_thresh=0.25, nms_conf_thres=0.3)
