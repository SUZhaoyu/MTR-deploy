...
def get_roi_bbox(input_coors, bboxes, input_num_list, anchor_size, expand_ratio=0.15):
    '''
    ...
    '''
    roi_attrs, roi_conf = get_roi_bbox_exe.get_roi_bbox_op(input_coors=input_coors,
                                                                      gt_bbox=bboxes,
                                                                      input_num_list=input_num_list,
                                                                      anchor_size=anchor_size,
                                                                      expand_ratio=expand_ratio)
    return roi_attrs, roi_conf
...
def get_bbox(roi_attrs, bboxes, input_num_list, expand_ratio=0.15, cls_num=4):
    bbox_attrs, bbox_conf, bbox_cls = get_bbox_exe.get_bbox_op(roi_attrs=roi_attrs,
                                                                gt_bbox=bboxes,
                                                                input_num_list=input_num_list,
                                                                expand_ratio=expand_ratio,
                                                                cls_num=cls_num)
    return bbox_attrs, bbox_conf, bbox_cls
...
def la_roi_pooling_fast(input_coors, input_features, roi_attrs, input_num_list, roi_num_list,
                        dimension, offset,
                        voxel_size=5, padding_value=0., pooling_size=8,
                        grid_buffer_resolution=0.3, grid_buffer_size=3):
